...
export var activations: { [key: string]: nn.ActivationFunction } = {
...
export var regularizations: { [key: string]: nn.RegularizationFunction } = {
  none: null,
...
export var datasets: { [key: string]: dataset.DataGenerator } = {
...
export var regDatasets: { [key: string]: dataset.DataGenerator } = {
...
export class State {
  ...
  static deserializeState(): State {
    ...
    var hideProps = getHideProps(map);
    for (var i = 0; i < hideProps.length; i++) {
      var prop = hideProps[i];
  ...
  serialize() {
    ...
    var hideProps = getHideProps(this);
    for (var i = 0; i < hideProps.length; i++) {
      var prop = hideProps[i];
